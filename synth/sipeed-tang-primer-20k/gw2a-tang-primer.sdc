...
set_input_delay -clock ulpi_clk -min 4 -max 12 [get_ports {ulpi_data ulpi_dir ulpi_nxt}]
set_output_delay -clock ulpi_clk -min 4 -max 12 [get_ports {ulpi_data ulpi_stp}]
